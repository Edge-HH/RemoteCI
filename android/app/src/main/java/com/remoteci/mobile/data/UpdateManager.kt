...
import com.remoteci.mobile.notif.UpdateReceiver
...
object UpdateManager {
    ...
    private val USER_AGENT = "RemoteCI-Mobile/${BuildConfig.VERSION_NAME}"
    private val STABLE_RELEASE_TAG = Regex("""^3\.[0-9]+\.[0-9]+\.[0-9]+$""")
    private val BETA_RELEASE_TAG = Regex("""^v3\.[0-9]+\.[0-9]+-beta\.[1-9][0-9]*$""")
    const val INSTALL_RESULT_ACTION = "com.remoteci.mobile.UPDATE_INSTALL_RESULT"
    ...
    fun findApkAsset(release: GitHubRelease): GitHubAsset? {
        val expectedName = "RemoteCI.Mobile-${versionFromTag(release.tagName)}.apk"
