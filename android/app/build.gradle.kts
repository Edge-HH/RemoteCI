...
val releaseVersion = providers.gradleProperty("releaseVersion").orNull ?: "3.2.1.4"
...
val releaseVersionMatch = Regex(
    ...
    ?: error("无效的 Android 版本号：$releaseVersion")
...
// 签名信息从 android/keystore.properties（本机）或 CI 环境变量读取；
...
android {
    namespace = "com.remoteci.mobile"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.remoteci.mobile"
        minSdk = 26
        targetSdk = 37
